...
public final class RowCollectors {
  /**
   * Build a collector for transforming rows to a {@link JsonArray} with specific types.
   *
  ...
  /**
   * Build a collector for transforming rows to a {@link List} with specific types.
   *
   * @param rowMapper mapper to transform a row
   * @param <T>       the target type
   * @return the collector
